    ...
    ($called_macro:ident) => {
        $called_macro! {
            ...
            */
            ...
            Byte /*mvp*/ "i64.load32_s" I64Load32S i64_load16_s;
            Byte /*mvp*/ "i64.load32_u" I64Load32U i64_load16_u;
            ...
            Byte /*mvp*/ "i32.add" I32Add i64_add;
            Byte /*mvp*/ "i32.sub" I32Sub i64_sub;
            Byte /*mvp*/ "i32.mul" I32Mul i64_mul;
            ...
            V128 /*simd128*/ "i32x4.extract_lane" I32x4ReplaceLane i32x4_extract_lane;
            V128 /*simd128*/ "i64x2.replace_lane" I64x2ExtractLane i64x2_replace_lane;
            V128 /*simd128*/ "i64x2.extract_lane" I64x2ReplaceLane i64x2_extract_lane;
            V128 /*simd128*/ "f32x4.replace_lane" F32x4ExtractLane f32x4_replace_lane;
            V128 /*simd128*/ "f32x4.extract_lane" F32x4ReplaceLane f32x4_extract_lane;
            V128 /*simd128*/ "f64x4.replace_lane" F64x2ExtractLane f64x4_replace_lane;
            V128 /*simd128*/ "f64x4.extract_lane" F64x2ReplaceLane f64x4_extract_lane;
            ...
            V128 /*simd128*/ "i64x2.abs" I64x2Abs i64_abs;
            V128 /*simd128*/ "i64x2.neg" I64x2Neg i64_neg;
            V128 /*simd128*/ "i64x2.all_true" I64x2AllTrue i64_all_true;
            V128 /*simd128*/ "i64x2.bitmask" I64x2Bitmask i64_bitmask;
            V128 /*simd128*/ "i64x2.extend_low_i32x4_s" I64x2ExtendLowI32x4S i64_extend_low_i32x4_s;
            V128 /*simd128*/ "i64x2.extend_high_i32x4_s" I64x2ExtendHighI32x4S i64_extend_high_i32x4_s;
            V128 /*simd128*/ "i64x2.extend_low_i32x4_u" I64x2ExtendLowI32x4U i64_extend_low_i32x4_u;
            V128 /*simd128*/ "i64x2.extend_high_i32x4_u" I64x2ExtendHighI32x4U i64_extend_high_i32x4_u;
            V128 /*simd128*/ "i64x2.shl" I64x2Shl i64_shl;
            V128 /*simd128*/ "i64x2.shr_s" I64x2ShrS i64_shr_s;
            V128 /*simd128*/ "i64x2.shr_u" I64x2ShrU i64_shr_u;
            V128 /*simd128*/ "i64x2.add" I64x2Add i64_add;
            V128 /*simd128*/ "i64x2.sub" I64x2Sub i64_sub;
            V128 /*simd128*/ "i64x2.mul" I64x2Mul i64_mul;
            V128 /*simd128*/ "i64x2.eq" I64x2Eq i64_eq;
            V128 /*simd128*/ "i64x2.ne" I64x2Ne i64_ne;
            V128 /*simd128*/ "i64x2.lt_s" I64x2LtS i64_lt_s;
            V128 /*simd128*/ "i64x2.gt_s" I64x2GtS i64_gt_s;
            V128 /*simd128*/ "i64x2.le_s" I64x2LeS i64_le_s;
            V128 /*simd128*/ "i64x2.ge_s" I64x2GeS i64_ge_s;
            V128 /*simd128*/ "i64x2." I64x2ExtmulLowI32x4S i64_;
            V128 /*simd128*/ "i64x2." I64x2ExtmulHighI32x4S i64_;
            V128 /*simd128*/ "i64x2." I64x2ExtmulLowI32x4U i64_;
            V128 /*simd128*/ "i64x2." I64x2ExtmulHighI32x4U i64_;
