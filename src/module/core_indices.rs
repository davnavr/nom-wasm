crate::index::definitions! {
    ...
    /// A [**`funcidx`**] refers to an [imported function] or a function defined in the
    /// [*function section*].
    ///
    ...
    /// A [**`tableidx`**] refers to an [imported table] or a table defined in the
    /// [*table section*].
    ///
    ...
    /// A [**`memidx`**] refers to an [imported memory] or a memory defined in the
    /// [*memory section*].
    ///
    ...
    /// A [**`globalidx`**] refers to an [imported global] or a global defined in the
    /// [*global section*].
    ///
    ...
    /// A [**`labelidx`**] refers to [structured control instructions] within the code of a
    /// function.
    ///
